...
export const metadata: Metadata = {
  title: 'NWL Australian School - Coming Soon',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-paper relative overflow-hidden">
      ...
      <div className="text-center relative z-10 px-6">
        ...
        {/* Heading */}
        <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-navy mb-4">
          Coming <span className="italic text-gold">Soon</span>
        </h1>
        <p className="text-navy/60 text-lg sm:text-xl max-w-md mx-auto mb-2">
          Our new website is launching soon.
        </p>
        <p className="text-navy/60 text-lg sm:text-xl max-w-md mx-auto mb-10">
