...
export default function FixedCTAButton() {
  ...
  return (
    <>
      ...
      >
        <div className="bg-white/95 backdrop-blur-sm border-t border-n-200 shadow-[0_-4px_20px_rgba(11,34,78,0.08)] px-3 pt-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
          <div className="grid grid-cols-2 gap-2">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 py-3 rounded-full font-medium text-navy border border-[#25D366]/50 bg-white"
            >
