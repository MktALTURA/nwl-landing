...
const partners = [
  ...
  { name: 'CFPN - Filosofía para Niños', src: '/images/logos/partners/CFPN(es).png', scale: 'large' },
  ...
  { name: 'Yo Soy Líder NWL', src: '/images/logos/partners/Yo_soy_lider_nwl(es).png', scale: '' },
];
