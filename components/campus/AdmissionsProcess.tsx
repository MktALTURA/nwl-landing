...
const stepColors = [
  { bg: 'bg-gold/10', text: 'text-gold-600', ring: 'ring-gold/20' },
  { bg: 'bg-navy/10', text: 'text-navy', ring: 'ring-navy/15' },
  { bg: 'bg-gold/10', text: 'text-gold-600', ring: 'ring-gold/20' },
  { bg: 'bg-navy/10', text: 'text-navy', ring: 'ring-navy/15' },
  { bg: 'bg-gold/10', text: 'text-gold-600', ring: 'ring-gold/20' },
];
...
export default function AdmissionsProcess() {
  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-b from-paper via-white to-n-100/60 relative overflow-hidden">
      {/* Decorative blurs like CampusFinder */}
      <div className="absolute top-0 right-0 w-48 h-48 bg-gold/10 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-10 w-56 h-56 bg-navy/5 rounded-full blur-3xl" />
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-navy">
            ...
            <span className="italic text-gold">{t.campusDetail.admissionsTitleAccent}</span>
          </h2>
          <p className="text-n-500 mt-4 text-lg max-w-2xl mx-auto">
        ...
        <div className="hidden lg:block max-w-5xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute top-8 left-[10%] right-[10%] h-0.5 bg-gold/20" />
            ...
            <div className="grid grid-cols-5 gap-4">
              {steps.map((step: { title: string; description: string }, i: number) => {
                ...
                return (
                  ...
                  >
                    {/* Step number + icon */}
                    <div className={`relative w-16 h-16 rounded-full ${colors.bg} ring-4 ${colors.ring} flex items-center justify-center mb-5 z-10`}>
                      {Icon ? (
                    ...
                    {/* Title */}
                    <h3 className="font-display text-base font-bold text-navy mb-2 leading-tight">
                      {step.title}
                    </h3>
            ...
            <div className="space-y-8">
              {steps.map((step: { title: string; description: string }, i: number) => {
                ...
                return (
                  ...
                  >
                    {/* Icon */}
                    <div className={`relative w-16 h-16 min-w-[4rem] rounded-full ${colors.bg} ring-4 ${colors.ring} flex items-center justify-center z-10`}>
                      {Icon ? (
                    ...
                    <div className="pt-2">
                      ...
                      <h3 className="font-display text-lg font-bold text-navy mt-1 mb-1">
                        {step.title}
                      </h3>
                      <p className="text-sm text-n-500 leading-relaxed">
                        {step.description}
