...
export const campuses: Record<string, CampusData> = {
  ...
  juriquilla: {
    ...
    facilities: [
      ...
      { name: { en: 'Playground', es: 'Área de Juegos' }, image: '/images/campus/juriquilla/juriquilla-playground-drone.jpg' },
    ...
    galleryImages: [
      ...
      { src: '/images/campus/juriquilla/juriquilla-carpool-lanes-drone.jpg', caption: { en: 'Carpool Lanes', es: 'Carriles de Ascenso y Descenso' } },
      ...
      { src: '/images/campus/juriquilla/juriquilla-soccer-field-ground.jpg', caption: { en: 'Soccer Field', es: 'Cancha de Fútbol' } },
      ...
      { src: '/images/campus/juriquilla/juriquilla-building-drone-wide.jpg', caption: { en: 'Campus from Above', es: 'Vista Aérea del Campus' } },
      { src: '/images/campus/juriquilla/juriquilla-building-lawn.jpg', caption: { en: 'Green Spaces', es: 'Áreas Verdes' } },
      { src: '/images/campus/juriquilla/juriquilla-playground-drone.jpg', caption: { en: 'Play, Explore & Grow', es: 'Jugar, Explorar y Crecer' } },
  ...
  milenio: {
    ...
    facilities: [
      { name: { en: 'Covered Sports Court', es: 'Cancha Deportiva Techada' }, image: '/images/campus/milenio/milenio-covered-court.jpg' },
      { name: { en: 'Science Labs', es: 'Laboratorios de Ciencias' }, image: '/images/campus/milenio/milenio-lab.jpg' },
      { name: { en: 'Classrooms', es: 'Salones de Clase' }, image: '/images/campus/milenio/milenio-classroom.jpg' },
      ...
      { name: { en: 'Campus Building', es: 'Edificio del Campus' }, image: '/images/campus/milenio/milenio-building.jpg' },
    ],
    activities: [
      {
        name: { en: 'Sports', es: 'Deportes' },
    ...
    galleryImages: [
      { src: '/images/campus/milenio/milenio-lider-sign.jpg', caption: { en: 'LÍDER Rooftop Sign', es: 'Letrero LÍDER en Azotea' } },
      { src: '/images/campus/milenio/milenio-soccer-field-hero.jpg', caption: { en: 'Soccer Field & Campus', es: 'Cancha de Fútbol y Campus' } },
      { src: '/images/campus/milenio/milenio-rooftop-terrace.jpg', caption: { en: 'Rooftop Terrace', es: 'Terraza en Azotea' } },
      { src: '/images/campus/milenio/milenio-volleyball-court.jpg', caption: { en: 'Volleyball Court', es: 'Cancha de Voleibol' } },
      ...
      { src: '/images/campus/milenio/milenio-nwl-kangaroo-art.jpg', caption: { en: 'NWL Kangaroo Mosaic Art', es: 'Mosaico del Canguro NWL' } },
      { src: '/images/campus/milenio/milenio-library-trophies.jpg', caption: { en: 'Library & Trophy Display', es: 'Biblioteca y Trofeos' } },
      { src: '/images/campus/milenio/milenio-kinder-playground-wide.jpg', caption: { en: 'Kinder Playground', es: 'Área de Juegos de Kínder' } },
      { src: '/images/campus/milenio/milenio-nurse-office.jpg', caption: { en: 'Nurse\'s Office', es: 'Enfermería' } },
      { src: '/images/campus/milenio/milenio-cafeteria.jpg', caption: { en: 'Cafetorium', es: 'Cafetorium' } },
      { src: '/images/campus/milenio/milenio-classroom.jpg', caption: { en: 'Kinder Classroom', es: 'Salón de Kínder' } },
      { src: '/images/campus/milenio/milenio-building.jpg', caption: { en: 'Campus Exterior', es: 'Exterior del Campus' } },
      { src: '/images/campus/milenio/milenio-lab.jpg', caption: { en: 'Science Lab', es: 'Laboratorio de Ciencias' } },
      { src: '/images/campus/milenio/milenio-playground.jpg', caption: { en: 'Playground', es: 'Área de Juegos' } },
    ],
    testimonials: [
      {
        quote: 'Mis hijos son los más felices. Han tenido un desarrollo increíble en lo social y lo cognitivo. En NWL somos parte de una gran familia con experiencias nuevas y enriquecedoras.',
