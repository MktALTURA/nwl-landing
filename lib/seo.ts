...
export const PAGE_SEO = {
  ...
  maternal: {
    title: 'Maternal Program (Ages 2–3) | Newland School',
    description:
  ...
  kinder: {
    title: 'Kinder Program (Ages 3–5) | Newland School',
    description:
  ...
  elementary: {
    title: 'Elementary School (Ages 6–11) | Newland School',
    description:
  ...
  middleSchool: {
    title: 'Middle School (Ages 12–15) | Newland School',
    description:
  ...
  highSchool: {
    title: 'High School — Prepa NWL (Ages 15–17) | Newland School',
    description:
