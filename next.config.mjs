      ...
      },
      {
        ...
        headers: [
          ...
          // Move to Content-Security-Policy once verified in production
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://link.msgsndr.com https://va.vercel-scripts.com https://cdn.jsdelivr.net https://www.googletagmanager.com https://connect.facebook.net",
